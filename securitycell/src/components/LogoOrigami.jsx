...
const LogoRolodex = ({ items }) => {
  ...
  return (
    <div
      ...
      className="relative z-0 h-20 w-36 shrink-0 rounded-xl  bg-transparent"
    >
...
const LogoItem = ({ children, className }) => {
  return (
    <div
      className={twMerge(
        "grid h-20 w-36 place-content-center rounded-lg bg-neutral-700 text-3xl text-neutral-50",
        className
      )}
    >
      {children}
